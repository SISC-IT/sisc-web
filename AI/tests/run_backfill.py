...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_date", type=str, default="2025-03-03", help="시작일 (YYYY-MM-DD)")
    parser.add_argument("--end_date", type=str, default="2026-03-19", help="종료일 (YYYY-MM-DD)")
