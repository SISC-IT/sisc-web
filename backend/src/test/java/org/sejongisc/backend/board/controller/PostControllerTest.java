...
class PostControllerTest {
        ...
        String body = """
            {
              ...
              "content":"수정내용",
              "postType":"NOTICE",
              "attachments":[{"filename":"n.pptx","mimeType":"application/pptx","url":"/n"}]
            }
            """;
    ...
    @Test
    @DisplayName("[GET] /api/posts — 목록 200")
    ...
    @Test
    @DisplayName("[GET] /api/posts/search — 검색 200")
    ...
    @Test
    @DisplayName("[POST] /api/posts/{postId}/comments — 댓글 생성 200")
    void createComment_ok() throws Exception {
        ...
        String body = """
          {"content":"댓글입니다","parentId":null}
        """;

        given(postService.createComment(eq(postId), any(CommentCreateRequest.class), eq(userId)))
        ...
        verify(postService).createComment(eq(postId), any(CommentCreateRequest.class), eq(userId));
    }
