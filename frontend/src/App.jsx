...
/**
 * Define application routes and render global UI, including protected and admin-only route groups and a toast container.
 * @returns {JSX.Element} The root React element containing the Routes configuration and a ToastContainer. */
function App() {
  return (
    <>
      <Routes>
