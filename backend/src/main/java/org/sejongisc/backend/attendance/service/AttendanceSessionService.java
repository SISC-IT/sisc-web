...
public class AttendanceSessionService {
    ...
    /**
     * 출석 세션 생성
     * - 세션 생성자(creatorUserId) 정보는 추후 활용 가능
     */
    @Transactional
    public void createSession(UUID creatorUserId, AttendanceSessionRequest request) {
        ...
        log.info("출석 세션 생성 완료: 세션ID={}, 생성자ID={}", saved.getAttendanceSessionId(), creatorUserId);
